...
<h4 class="header-title mb-4">{{$post->title}}</h4>

{!! Form::model( $post ,[ 'url' => config('settings.BackendPath').'/pages/'.$post->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}
...
{!! Form::textarea('intro' , $post->intro , ['rows' => '3' , 'class' => 'form-control' , 'placeholder'=> 'intro'] ) !!}
...
{!! Form::textarea('content' , $post->content , ['id'=>'summernote-editor' ,  'rows' => '3' , 'class' => 'summernote' , 'placeholder'=> 'Body'] ) !!}
